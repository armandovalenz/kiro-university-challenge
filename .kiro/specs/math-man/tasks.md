...
- [x] 1. Scaffold the Phaser + Vite project
...
- [x] 2. Implement the Storage module with in-memory fallback
...
- [x] 3. Implement the ScoreSystem module
...
- [x] 4. Build the BootScene and asset preload pipeline
...
- [x] 5. Build the SplashScene with the Math Man logo
...
- [x] 6. Build the MenuScene with grade selection and high score
...
- [x] 7. Implement the Maze model and tilemap
...
- [x] 11. Implement ghost/Math Man collision and reset
...
- [x] 12. Implement the QuestionBank (load the bundled JSON bank)
...
- [x] 13. Build the QuizScene, QuizModal, and QuizSystem
...
- [x] 14. Implement fruit, LessonBank, and the LessonScene
...
- [x] 15. Implement level progression and level-clear handling
...
- [x] 16. Build the PauseScene and GameOverScene
...
- [x] 17. Implement the AudioBus and wire all event sounds
