...
- [x] 1. Add the Three.js dependency and FP3D configuration
...
- [x] 2. Implement FP3D coordinate mapping in `fp3dLogic.js`
...
- [x]* 3. Write property test for coordinate round-trip
...
- [x] 4. Implement movement resolution, facing, and input buffering in `fp3dLogic.js`
...
- [x]* 5. Write property tests for movement, facing, and buffering
...
- [x] 6. Implement tunnel-wrap resolution in `fp3dLogic.js`
...
- [x]* 7. Write property test for tunnel-wrap resolution
...
- [x] 8. Implement `lineOfSight.js` grid line-of-sight
...
- [x]* 9. Write property test for line-of-sight
...
- [x] 12. Implement the Three.js renderer core (`FP3DRenderer.js`)
...
- [x] 13. Implement renderer markers, ghosts, and occlusion
...
- [x] 14. Implement `FP3DScene` gameplay loop and collectible collection
...
- [x] 15. Wire the capture → quiz and fruit → lesson loops with freeze
...
- [x] 16. Add the menu Render_Mode toggle, scene registration, and WebGL fallback
...
- [x] 17. Implement accessibility controls and reduced-motion
...
- [x] 18. Implement asset, audio, and storage fallbacks
